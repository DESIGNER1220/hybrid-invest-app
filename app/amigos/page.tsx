    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950 px-3 pb-24 pt-3 text-white">
      <div className="mx-auto max-w-md space-y-3">
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-4">
          <p className="text-xs text-slate-400">Número de amigos</p>
          <h2 className="mt-2 text-3xl font-bold text-amber-400">{referrals}</h2>
        </div>

        <div className="rounded-xl border border-white/10 bg-white/5 p-4">
          <p className="text-xs text-slate-400">Seu código de referência</p>
          <h2 className="mt-2 break-all text-base font-bold text-blue-400">
