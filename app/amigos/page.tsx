          ...
          <form onSubmit={handleCreateBonus} className="mt-3 space-y-3">
            <div className="grid grid-cols-1 gap-2">
              <input
                ...
                placeholder="Código automático ou manual"
              ...
              >
                {generatingCode ? "Gerando..." : "Gerar código automático"}
              </button>
            </div>
            ...
            <button
              ...
              className="w-full rounded-lg bg-amber-500 px-4 py-2 text-sm font-bold text-black transition hover:bg-amber-400 disabled:opacity-70"
            >
