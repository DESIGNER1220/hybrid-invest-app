  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-amber-950 px-4 pb-28 pt-6 text-white">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-3xl font-bold">Levantamento</h1>
        <p className="mt-2 text-slate-300">
          Escolha o método e envie o seu pedido de levantamento.
        </p>
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="rounded-2xl bg-amber-500 px-5 py-3 font-semibold text-slate-950 transition hover:bg-amber-400 disabled:opacity-70"
          >
